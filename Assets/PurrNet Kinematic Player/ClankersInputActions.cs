...
//     version 1.14.2
//     from Assets/PurrNet Kinematic Player/ClankersInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/PurrNet Kinematic Player/ClankersInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @ClankersInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @ClankersInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""ClankersInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@ClankersInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ClankersInputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ClankersInputActions.UI.Disable() has not been called.");
    }
    ...
    {
        private @ClankersInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@ClankersInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@ClankersInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
